        ...
        <div>
            ...
            <div className="flex bg-black items-start md:items-center min-h-fit lg:h-[92vh]">
                <div className="flex flex-wrap justify-between items-start my-10 md:items-center w-full">
                    ...
                    <div className="flex-[100%] md:flex-[45%] ml-3 lg:ml-0">
                        ...
                        <p className="text-neutral-500 font-light mb-5">{`${item.ratingCount} Ratings | 53 Comments`}</p>
                        ...
                        <form onSubmit={handleSubmit}>
                            <p className="text-neutral-500 font-normal mb-1">Quantity:</p>
                            <QuantityInput max={item.stock}/>
                            <div className="mt-5">
                                <span className="text-neutral-500 font-normal">Availability:</span>
